...
- If you have found a bug, create an [issue](https://github.com/mbeiter/crypto4j/issues) on GitHub
- If you want to submit a feature request, send an email to Mike (<michael@beiter.org>)

## Workflow

- Check the [issue tracker](https://github.com/mbeiter/crypto4j/issues) to find out if the problem has already been
  reported. If you find the problem on the tracker, add additional details.
- Create an [issue](https://github.com/mbeiter/crypto4j/issues) on GitHub
